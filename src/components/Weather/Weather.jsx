      ...
      <Full>
        <Container>
            ...
            {weather && weather.weather &&
                <Content>
                    <WeatherImage>
                        <WeatherImageImg src={`https://openweathermap.org/img/wn/${weather.weather[0].icon}@2x.png`} />
                        <WeatherImageDesc>{weather.weather[0].description}</WeatherImageDesc>
                    </WeatherImage>
                    <WeatherTemp>{weather.main.temp}<span>&deg;C</span></WeatherTemp>
                    <WeatherCity>
                        <LocationIcon />
                    ...
                    <WeatherStats>
                        <Wind>
                            <WindIcon />
                            <WindSpeed>{weather.wind.speed}<span>Km/h</span></WindSpeed>
                            <WindHeading>Wind Speed</WindHeading>
                        </Wind>
                        <Humidity>
                            <HumidityIcon />
                            <HumidityPercent>{weather.main.humidity}<span>%</span></HumidityPercent>
